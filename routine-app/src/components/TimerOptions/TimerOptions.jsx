...
const TimerOptions = ({ top, left, onClose, play, setMinutes, setSeconds, setWorkDuration, setBreakDuration, breaks }) => {
    ...
    <div className="options-view" style={{ top, left }}>
      <ul>
        <li className="main-dropdown solid-white-background" onMouseEnter={() => setWorkHover(true)} onMouseLeave={() => setWorkHover(false)}>
          ...
          {workHover && (
            <div className="dropdown-options">
              <WorkDurationOptions play={play} setMinutes={setMinutes} setSeconds={setSeconds} setWorkDuration={setWorkDuration} breaks = {breaks} />
            </div>
          )}
        </li>
        <li className="main-dropdown solid-white-background" onMouseEnter={() => setBreakHover(true)} onMouseLeave={() => setBreakHover(false)}>
          ...
          {breakHover && (
            <div className="dropdown-options">
              <BreakDurationOptions play={play} setMinutes={setMinutes} setSeconds={setSeconds} setBreakDuration={setBreakDuration} breaks = {breaks} />
            </div>
          )}
        </li>
